...
export default function PlanPage() {
  ...
  return (
    <div className="p-3 md:p-4 max-w-2xl mx-auto pb-24">
      ...
      <Card className="border-0 shadow-sm mb-3">
        <CardContent className="p-3 grid grid-cols-2 gap-2">
          ...
          <div className="col-span-2">
            <label className="text-xs font-semibold mb-1 block">Título / objetivo del día {isPureProfe ? '' : '(opcional)'}</label>
            {isPureProfe ? (
              <p className="w-full px-3 py-2.5 border rounded-lg text-sm bg-gray-50 min-h-[42px]">{title || '—'}</p>
            ) : (
      ...
      {/* Profe puro: solo lectura — el plan lo define el coordinador */}
      {isPureProfe ? (
